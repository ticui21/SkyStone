...
public class DrivetrainHolo {
    ...
    public DrivetrainHolo(HardwareMap hardwareMap) {
    ...
    public void strafeUpLeft(double power) {
        frontRightDrive.setPower(power);
        rearLeftDrive.setPower(power);
    }

    public void strafeUpRight(double power) {
        frontLeftDrive.setPower(power);
        rearRightDrive.setPower(power);
    }

    public void strafeDownLeft(double power) {
        strafeUpRight(-power);
    }
